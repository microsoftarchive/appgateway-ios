...
@protocol SettingsMenuControllerDelegate <NSObject>
...
@interface SettingsMenuController : UITableViewController

@property (nonatomic, weak) id<SettingsMenuControllerDelegate> delegate;
