...
@protocol RouterSettingsViewControllerDelegate;

@interface RouterSettingsViewController : UITableViewController <UITextFieldDelegate, UIAlertViewDelegate>

@property (nonatomic, weak) id <RouterSettingsViewControllerDelegate> delegate;
@property (nonatomic) RouterSettings *settings;

@end

@protocol RouterSettingsViewControllerDelegate <NSObject>
